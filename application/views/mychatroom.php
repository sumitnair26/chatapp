 ...
 function sendmsg(id)
   ...
   //die;
	...
	success:  function(data){
            ...
            $('.modal-title').text('Start Chating'); // Set title to Bootstrap modal title
	}
	});   
	}
</script>
...
//echo $this->session->userid; 
	   echo $this->session->username; ?> </h2>
	          ...
	          <ul class="nav nav-pills nav-stacked labels-info ">
                          ...
                          <li> <a onClick="getallmsg(<?php echo $friends['relation_id']; ?>)"> <i class=" fa fa-circle text-success"></i> Coversation <?php echo $friends['relation_id']; ?> </a>  </li>
                         <?php } ?>
                          </li>
           </ul>
			 ...
			 <ul class="nav nav-pills nav-stacked labels-info ">
                          ...
                          <li> <a onClick="addnewchat(<?php echo $users['user_id']; ?>)"> <i class=" fa fa-circle text-danger"></i><?php echo $users['username']; ?> </a>  </li>
                         <?php } ?>
                          </li>
           </ul>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
	  ...
	  <form action="<?php echo base_url(); ?>chat/startconversation" method="post">
        <input id="friendid" name="friendid" style="display:none">
		  <textarea class="form-control" rows="5" id="message" name="message" placeholde="Enter Message" required></textarea>
